...
const makeStyles = (colors: ColorPalette) => StyleSheet.create({
  ...
  infoText: { fontSize: FontSize.sm, color: colors.textSecondary, fontWeight: '500' },
  difficultyPill: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.sm, paddingVertical: 4, borderRadius: BorderRadius.full, gap: 6 },
  difficultyDotSmall: { width: 6, height: 6, borderRadius: 3 },
  difficultyPillText: { fontSize: FontSize.xs, fontWeight: '600' },
  description: { fontSize: FontSize.md, color: colors.textSecondary, lineHeight: 22, marginBottom: Spacing.md },
  muscleGroupRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm, marginBottom: Spacing.xl },
  muscleTag: { backgroundColor: colors.primaryDark + '40', paddingHorizontal: Spacing.md, paddingVertical: 6, borderRadius: BorderRadius.full },
  muscleTagText: { fontSize: FontSize.sm, color: colors.primaryLight, fontWeight: '600' },
  sectionTitle: { fontSize: FontSize.lg, fontWeight: '700', color: colors.text, marginBottom: Spacing.md },
  exerciseCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: BorderRadius.md, padding: Spacing.md, marginBottom: Spacing.sm, gap: Spacing.md },
  exerciseNumber: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.primaryDark, alignItems: 'center', justifyContent: 'center' },
  exerciseNumberText: { fontSize: FontSize.md, fontWeight: '700', color: colors.primaryLight },
  exerciseInfo: { flex: 1 },
  exerciseName: { fontSize: FontSize.md, fontWeight: '600', color: colors.text, marginBottom: 4 },
  exerciseMeta: { flexDirection: 'row', gap: Spacing.md },
  exerciseMetaText: { fontSize: FontSize.sm, color: colors.textSecondary },
  exerciseRest: { fontSize: FontSize.sm, color: colors.textMuted },
  ...
  startButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary, borderRadius: BorderRadius.md, paddingVertical: Spacing.md, gap: Spacing.sm },
  startButtonText: { fontSize: FontSize.lg, fontWeight: '700', color: colors.white },
