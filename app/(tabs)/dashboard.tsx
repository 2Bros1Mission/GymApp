...
export default function TrainerDashboardScreen() {
  ...
  ), [styles, colors, t, displayName, error, loading, retry, clients, workouts, trainerCode, recentActivity.length, router]);
  ...
  ), [styles, colors, t, error, clients, workouts, language, router, getDifficultyColor]);

  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        data={!error ? recentActivity : []}
